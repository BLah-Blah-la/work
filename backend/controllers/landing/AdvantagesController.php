...
use backend\models\landing\search\AdvantagesSearch;
...
class AdvantagesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $items = [];
        foreach(Advantages::find()->all() as $var){
     
		$items[] =  [
                'content' => Html::img(Url::toRoute([$var->logo, 'id' => $var->id])),
                'caption' => $var->description,
